...
def create_simple_annotation(text_file: Path, wavs_dir: Path, output_file: Path, session_id: str):
...
def main():
    if MODE == "single":
        ...
        for tf in text_files:
            ...
            if wav_dir.exists():
                create_simple_annotation(tf, wav_dir, BATCH_OUT_DIR / f"{tf.stem}.json", tf.stem)
            else:
